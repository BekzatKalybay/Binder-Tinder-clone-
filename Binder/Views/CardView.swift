...
class CardView: UIView {
    ...
    fileprivate func setupLayout() {
        ...
        //Pay attention on Z index: layers order queue
    ...
    override func layoutSubviews() {
        //Here CardView frame is already drawn
    ...
    fileprivate func handleChanged(_ gesture: UIPanGestureRecognizer) {
        //Figuring out measure when we want to move our card
        let translation = gesture.translation(in: nil)
        
        //rotation
        //convert radians to degrees
        let degrees: CGFloat = translation.x / 20 //divide by 20 to decrease rotation angle
    ...
    fileprivate func handleEnded(_ gesture: UIPanGestureRecognizer) {
        ...
        UIView.animate(withDuration: 1, delay: 0, usingSpringWithDamping: 0.6, initialSpringVelocity: 0.1, options: .curveEaseOut, animations: {
            if shouldDismissCard {
                ...
                self.transform = .identity //Bringing card back to its place
            }
        }) { _ in
